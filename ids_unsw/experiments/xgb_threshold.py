...
def main():
    ...
    # Predict probabilities (handles XGBClassifier or Booster)
    ...
    # ---- Cell 6: choose operating threshold (match your notebook’s rule)
    ...
    # ---- Cell 7: final metrics at chosen threshold (+ ROC AUC)
